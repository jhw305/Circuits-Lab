...
if __name__ == "__main__" :
	...
	r_out_theory_csa = 1.0 / ( ( 1.0 / R_D ) + ( 1.0 / ro_csa ) )
	...
	gain_theory = -1 * g_m_csa * ( 1.0 / ( ( 1.0 / R_D ) + ( 1.0 / R_L ) + ( 1.0 / ro_csa ) ) )
	...
	gain_theory_6 = -1 * ( g_m_csa * R_L * ( 1.0 / ( ( 1.0 / R_D ) + ( 1.0 / ro_csa ) ) ) ) / ( r_out_theory_cda + R_L )
